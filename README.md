...
Flowtide is now structured so language analysis and test execution support can be extended easily by writing adapters and simply registering them in the appropriate registries.
